...
public class boomSpecimenAutonBlue extends LinearOpMode{
    DcMotorEx frontLeft;
    ...
    public void runOpMode(){
        ...
        TrajectorySequence traj1 = drive.trajectorySequenceBuilder(startPose)
                ...
                //go to zone
                .lineToSplineHeading(new Pose2d(-58, 46, Math.toRadians(270)))
                .addDisplacementMarker(() -> {
                    arm.setPower(0.5);
                    arm.setTargetPosition(0);
                    wrist.setPosition(1);
                ...
                //go to pickup
                .lineToSplineHeading(new Pose2d(-36, 58, Math.toRadians(90)))
                ...
                //go to bar
                .lineToSplineHeading(new Pose2d(-9.25, 40, Math.toRadians(270)))
                .addDisplacementMarker(() -> {
                    arm.setPower(0.5);
                    arm.setTargetPosition(600);
                    slides.setPower(0.8);
                ...
                //go to bar
                .lineToSplineHeading(new Pose2d(-6.5, 40, Math.toRadians(270)))
                .addDisplacementMarker(() -> {
                    arm.setPower(0.5);
                    arm.setTargetPosition(600);
                    slides.setPower(0.8);
                ...
                //go to bar
                .lineToSplineHeading(new Pose2d(-3.75, 40, Math.toRadians(270)))
                .addDisplacementMarker(() -> {
                    arm.setPower(0.5);
                    arm.setTargetPosition(600);
                    slides.setPower(0.8);
                ...
                //park
                .lineToSplineHeading(new Pose2d(-57, 62, Math.toRadians(0)))
                .build();
